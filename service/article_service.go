...
import (
	"github.com/AndriyKalashnykov/gqlgen-example/model"
	"github.com/AndriyKalashnykov/gqlgen-example/repository"
	"sync"
)
...
// This multiplexer routes incoming Articles from the articleRepository to every active subscriber.
